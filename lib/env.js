...
function demoDb() {
  ...
  const contacts = [
    ...
    mk({ id: "c2", jobId: jobA, name: "Priya Natarajan", headline: "Security Engineer, Detection and Response", company: "Fenwick Labs", location: "Leeds, UK", profileUrl: priyaUrl, status: "Replied", createdAt: ago(7), updatedAt: ago(2) }),
    ...
    mk({ id: "c4", jobId: jobA, name: "Aisha Bello", headline: "Threat Detection Lead", company: "Cirrus Security", location: "London, UK", profileUrl: "https://www.linkedin.com/in/sample-aisha-bello", status: "Interviewing", createdAt: ago(12), updatedAt: ago(4) }),
    mk({ id: "c5", jobId: jobA, name: "Sam Whitfield", headline: "SOC Analyst II", company: "Blythe Group", location: "Birmingham, UK", profileUrl: "https://www.linkedin.com/in/sample-sam-whitfield", status: "Shortlisted", createdAt: ago(6), updatedAt: ago(3) }),
    ...
    mk({ id: "c7", jobId: jobA, name: "Nadia Rossi", headline: "Cyber Analyst", company: "Meridian", location: "Edinburgh, UK", profileUrl: "https://www.linkedin.com/in/sample-nadia-rossi", status: "Not Interested", createdAt: ago(11), updatedAt: ago(6) }),
